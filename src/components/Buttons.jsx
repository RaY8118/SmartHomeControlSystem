...
const Buttons = ({ devices, toggleShow }) => {
  ...
  const handleToggle = (relay, setRelay, relayId) => {
    ...
    toast.success(
      `${devices[relayId] || "Relay"} switched ${newRelayState ? "ON" : "OFF"}`
    );
  };
      ...
      <header className="App-header">
        ...
        <div>
          <label>
            ...
            <span>Current State: {relay1 ? "ON" : "OFF"}</span>
          </label>
        </div>
        <div>
          <label>
            ...
            <span>Current State: {relay2 ? "ON" : "OFF"}</span>
          </label>
        </div>
        <div>
          <label>
            ...
            <span>Current State: {relay3 ? "ON" : "OFF"}</span>
          </label>
        </div>
        <div>
          <label>
            ...
            <span>Current State: {relay4 ? "ON" : "OFF"}</span>
          </label>
        </div>
      </header>
    </div>
